...
const EXAMPLES = [
    ...
    "select_plots.jl         - choose figures: pattern/3d path/3d path (webgl)/time series/power/aerodynamics" => "select_plots.jl",
    ...
    "create_plots.jl         - batch-generate pattern/time-series/power/aerodynamics PNGs for notebooks/images" => "create_plots.jl",
